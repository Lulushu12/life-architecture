...
export const OR_DAYS = [4, 5];
export const SUNDAY = [0];

export const DEFAULT_DAYS = { hf_gym: MON_SAT, d10: OR_DAYS, d11: OR_DAYS, d12: OR_DAYS, d17: SUNDAY };

export const BREATH_QUEST = { id: "hf_breath", title: "Breathwork or meditation", category: "Health & Fitness", baseXp: 50, streak: 0, lastDone: "", note: "Auto from Breathe, or tick by hand" };
...
export const DEFAULT_DAILY_V2 = [
  ...
  { id: "hf_gym",      title: "Training session done",               category: "Health & Fitness", baseXp: 75,  streak: 0, lastDone: "", note: "Auto: completes from the workout log", auto: true, days: MON_SAT },
  { id: "hf_protein",  title: "Hit protein target (160g)",           category: "Health & Fitness", baseXp: 50,  streak: 0, lastDone: "", note: "Auto: from the day's macro totals", auto: true },
  { id: "hf_kcal",     title: "Within caloric budget (2,100)",       category: "Health & Fitness", baseXp: 75,  streak: 0, lastDone: "", note: "Auto: from the day's macro totals", auto: true },
  ...
  { id: "d10", title: "Surgical case documented",          category: "Medicine & Surgery",   baseXp: 75,  streak: 0, lastDone: "", note: "OR days", days: OR_DAYS },
  { id: "d11", title: "Pre-op case prep completed",        category: "Medicine & Surgery",   baseXp: 50,  streak: 0, lastDone: "", note: "OR days", days: OR_DAYS },
  { id: "d12", title: "Post-op notes completed same day",  category: "Medicine & Surgery",   baseXp: 75,  streak: 0, lastDone: "", note: "OR days", days: OR_DAYS },
  ...
  { id: "d17", title: "Weekly review completed",           category: "Trading",              baseXp: 150, streak: 0, lastDone: "", note: "Sunday", days: SUNDAY },
...
export const DEFAULT_LONG = [
  ...
  { id:"l5",  title:"Lose 15kg total by end of summer",                      category:"Health & Fitness",     xp:2000, status:"Active",  notes:"Hard deadline: end of September", due:"2026-09-30" },
