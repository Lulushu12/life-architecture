---
title: Fracturile oaselor mâinii
probe: ct
number: 11
tags: fracturi metacarpiene, fracturi falangiene, scafoid, boxer's fracture, Bennett, Rolando, Herbert, K-wire, mallet finger, Seymour, SNAC, ORIF mână
region: Hand & Wrist
specialty: Hand & Wrist
related: diagnoses/hand-wrist-conditions, diagnoses/scaphoid-carpal-instability, techniques/metacarpal-phalangeal-fracture-fixation, techniques/percutaneous-screw-fixation-scaphoid-fracture, classifications/herbert-fisher-classification-scaphoid-fracture
---
...
**Metacarpiene:**
- Localizare: cap, col, diafiză, bază.
- Boxer's fracture (col MC V): angulare acceptabilă mai mare datorită mobilității CMC compensatorii.
- Bennett: fractură-luxație a bazei metacarpianului I, traiect intraarticular oblic, fragment volar mic rămas atașat de trapez prin ligamentul beak, restul osului subluxat dorsal-radial.
- Rolando: variantă cominutivă a Bennett, traiect în T sau Y, prognostic mai rezervat prin dificultatea reconstrucției congruenței articulare.
- Reverse Bennett: echivalentul la baza metacarpianului V, articulația CMC a V, mai rar.

**Falange:**
- Extraarticulare (diafizare, col) versus intraarticulare (condiliene unicondiliene/bicondiliene, baza).
- Fracturi-luxație IFP: clasificate după procentul suprafeței articulare implicate și direcția de subluxație (dorsală cea mai frecventă); semnul "V" (V sign) pe radiografia laterală indică subluxație/incongruență articulară subtilă a bazei falangei mijlocii.
...
|---|---|---|
| Herbert | stabilitate + acuitate | ghidează chirurgical vs conservator |
| Mayo | localizare | risc de nonunion/AVN |
| Russe | orientare traiect | risc de forfecare/instabilitate |

**Clasic vs actual:** manualele românești clasifică scafoidul preponderent după localizare (Mayo) și tratează majoritatea fracturilor conservator; practica actuală (Rockwood, Campbell) folosește Herbert pentru a selecta precoce fixarea cu șurub percutan la fracturile stabile la pacienți activi, reducând timpul de imobilizare.
...
Pacientul/a în vârstă de [vârstă] ani, [profesie, ex. manual/sportiv], din [mediu], se prezintă pentru durere și tumefacție la nivelul mâinii [drepte/stângi], la [interval] ore/zile de la un traumatism prin [mecanism: cădere pe mână în extensie / lovire cu pumnul închis / prindere degete].
...
Diagnostic pozitiv: fractură [metacarpian/falangă/scafoid], [localizare exactă, ex. col MC V / bază MC I tip Bennett / talie scafoid tip Herbert B2], pe baza mecanismului traumatic, a durerii și tumefacției localizate cu sensibilitate punctuală, și a aspectului radiografic de traiect de fractură cu [deplasare/angulare specifică].

Diagnostice secundare de reținut: leziuni ligamentare asociate (Stener la police), leziuni tendinoase asociate, malrotație care nu se vede pe radiografie ci doar clinic.

### 5. Diagnostic diferențial (1 min)

Entorsă de ligament colateral ulnar MCF I: fără linie de fractură la radiografie, dar instabilitate la stress în valgus (posibilă leziune Stener). Luxație CMC pură: subluxație fără traiect de fractură vizibil. Tendinopatie De Quervain: fără istoric traumatic acut, test Finkelstein pozitiv. Boală Kienböck: durere carpiană cronică, fără traumatism recent, colaps al semilunarului la imagistică. Chist sinovial dorsal: fără traumatism acut recent, masă chistică palpabilă.
...
### Î4. Ce faceți dacă radiografia inițială este negativă dar pacientul are sensibilitate marcată în tabachera anatomică?
**R:** Suspiciunea clinică de fractură de scafoid ocultă rămâne, pentru că sensibilitatea radiografiei standard este de doar 70 la 80%. Imobilizez provizoriu în orteză police-antebraț și repet radiografia la 10-14 zile, când resorbția osoasă locală face fractura vizibilă, sau indic direct CT/RMN pentru diagnostic precoce, RMN având sensibilitate peste 95%.

### Î5. Cum verificați clinic malrotația unei falange fracturate?
**R:** Cer pacientului să flecteze activ degetele complet (nu extensie) și verific alinierea plăcuțelor unghiale, care în mod normal converg spre osul scafoid; o rotație de câteva grade la baza degetului se amplifică semnificativ la vârful degetului prin efectul de pârghie lung. Zero grade de malrotație sunt acceptate la falange, spre diferență de metacarpiene.

### Î6. Ce este semnul V (V sign) și ce semnifică?
**R:** Este un semn radiografic pe incidența laterală la fracturile-luxație IFP, constând într-o linie în formă de V la nivelul suprafeței articulare a bazei falangei mijlocii, care indică subluxație sau incongruență articulară subtilă, adesea greu vizibilă altfel. Prezența lui impune reevaluare a stabilității și, frecvent, tratament chirurgical.

### Î7. Ce faceți dacă un copil se prezintă cu o leziune care pare simplă avulsie a unghiei după traumatism al vârfului degetului?
**R:** Exclud activ fractura Seymour, o fractură Salter-Harris I/II a bazei falangei distale cu interpoziția matricei unghiale în focar; radiografic pot observa o lărgire a spațiului fizar. O tratez ca fractură deschisă: explorare, extracția matricei interpuse, reducere, eventual fixare cu ac, și antibioterapie, pentru a preveni deformarea unghială permanentă și osteomielita.

### Î8. Care este aportul vascular al scafoidului și de ce influențează prognosticul?
**R:** Vascularizația este predominant retrogradă, din ramura carpiană dorsală a arterei radiale, care intră distal pe os și irigă polul proximal ultim, printr-un flux intraosos ascendent. Fracturile polului proximal întrerup acest flux mai frecvent, motiv pentru care au risc mult mai mare de necroză avasculară și nonunion comparativ cu fracturile de talie sau tubercul distal.

### Î9. Ce faceți dacă la o fractură Rolando cominutivă nu puteți reconstitui congruența articulară cu șuruburi?
**R:** Recurg la fixare cu placă în T sau L pentru fragmentele mari, combinată eventual cu fixator extern static/dinamic pentru ligamentotaxis pe fragmentele mici cominutive, sau, dacă reconstrucția anatomică nu este posibilă, accept o reducere funcțională cu prioritate pe alinierea coloanei metacarpianului, informând pacientul despre riscul de artroză CMC secundară.

### Î10. Care este diferența dintre mallet finger osos și tendinos?
**R:** Mallet finger osos implică o avulsie a fragmentului osos dorsal al bazei falangei distale, vizibilă radiografic; mallet finger tendinos este o ruptură a tendonului extensor terminal fără fragment osos, nevizibilă radiografic. Clinic ambele produc deformare în flexie a IFD cu incapacitate de extensie activă; tratamentul este similar (atelă în extensie 6-8 săptămâni), dar fragmente osoase mari cu subluxație volară pot necesita fixare chirurgicală.

### Î11. Ce este cadrul Suzuki și când se folosește?
**R:** Este un fixator extern dinamic tip "pins and rubber bands", folosit la fracturile-luxație IFP complexe, pilon fracturi ale bazei falangei mijlocii, cu cominuție importantă. Principiul este ligamentotaxis: distracția articulară prin benzi elastice reduce indirect fragmentele mici prin tracțiunea capsulo-ligamentară, permițând totodată mobilizare activă precoce, ceea ce reduce rigiditatea comparativ cu imobilizarea rigidă.

### Î12. Ce faceți dacă un pacient cu nonunion de scafoid vechi de 2 ani se prezintă cu durere carpiană progresivă?
**R:** Evaluez stadiul SNAC wrist prin radiografie și eventual CT, verificând implicarea articulației radioscafoidiene și capitolunată. În stadii precoce (fără artroză mediocarpiană extinsă) tentez grefare osoasă (tip Russe sau vascularizată) cu fixare; în stadii avansate cu artroză extinsă, opțiunile de salvare sunt proximal row carpectomy sau four-corner fusion (artrodeză capitolunată-scafoidectomie), în funcție de starea articulației radiolunate.

### Î13. Care sunt opțiunile de fixare pentru un metacarpian diafizar instabil, oblic lung?
**R:** Un traiect oblic lung permite fixare cu șuruburi de compresiune interfragmentară (lag screws), minim 2 șuruburi perpendiculare pe traiect pentru stabilitate rotațională, ceea ce oferă fixare rigidă și permite mobilizare precoce fără imobilizare externă suplimentară prelungită. Alternativ, placă neutralizantă dacă osul este subțire sau traiectul nu permite fixare stabilă doar cu șuruburi.

### Î14. Cum diferențiați clinic o leziune Stener de o entorsă simplă de ligament colateral ulnar al policelui?
