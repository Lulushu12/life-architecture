...
**Conservator:** TLICS/SLIC sub 4: compresiune stabilă, burst incomplet fără deficit și cu PLC intact. Orteză TLSO 8-12 săptămâni; corset Jewett (3 puncte de contact, contraindicat la flexie-distracție, nu controlează flexia) pentru compresiuni izolate anterioare; halo-vest pentru leziuni cervicale superioare stabile selectate (odontoid tip I, Jefferson sub pragul Spence, hangman tip I).

**Chirurgical, indicații:** TLICS/SLIC peste 4, deficit neurologic progresiv, compromitere de canal semnificativă (peste 50% (?) toracic), PLC rupt confirmat RMN, cifoză segmentară peste prag (20-30 grade (?)), fracturi tip B și C AO Spine.

**Timing decompresiei:** cât mai rapid, ideal sub 24 de ore, pe baza dovezilor STASCIS, care a arătat rezultate neurologice mai bune la decompresia precoce comparativ cu cea tardivă, fără creșterea semnificativă a complicațiilor.

**Principii de tehnică:** fixare posterioară cu șuruburi pediculare, short-segment sau long-segment după cominuția coloanei anterioare; laminectomie decompresivă la fragment retropulsat cu compresie directă; abord anterior (corporectomie, cage, placă) la burst-uri severe cu pierdere mare de suport; cimentoplastie percutană la fracturi osteoporotice pentru a preveni cut-out.

**Odontoid:** tip II la tânăr activ cu deplasare peste 5mm: șurub odontoidian anterior sau artrodeză posterioară C1-C2; la vârstnic, halo-vest slab tolerat (mortalitate crescută), se preferă fixarea directă. Tip III, frecvent conservator, prin suprafața spongioasă mare.

**Hangman:** tip I, orteză rigidă; tip II și IIA, tracțiune CONTRAINDICATĂ la IIA, halo-vest sau fixare posterioară C1-C3 dacă instabil; tip III, fixare chirurgicală obligatorie prin luxația facetară asociată.

**Jefferson:** sub pragul Spence, orteză rigidă/halo; peste prag, artrodeză C1-C2 posterioară.

**Fracturi osteoporotice:** analgezie, mobilizare precoce, orteză ușoară; kyphoplasty pentru durere refractară sub 6-8 săptămâni, fără deficit neurologic, cu ameliorare rapidă, deși beneficiul pe termen lung față de conservator este dezbătut.

**Pediatric SCIWORA:** leziune medulară fără anomalie radiografică, mai frecventă la copii prin elasticitatea ligamentară crescută; RMN obligatorie pentru diagnostic, tratament predominant conservator, prognostic variabil după severitatea leziunii inițiale.

### Complicații

Neurologice: deficit motor/senzitiv permanent, disfuncție sfincteriană, sindrom de con/cauda equina. Mecanice: pseudartroză (odontoid tip II, hangman tip IIA), cifoză progresivă, eșec de instrumentație. Generale: tromboembolism venos, escare, infecții urinare recurente, pneumonie (leziuni cervicale înalte), disreflexie autonomă (leziuni peste T6).

### Evoluție și prognostic

Fracturile stabile tratate conservator au prognostic bun, consolidare la 8-12 săptămâni. Leziunile cu deficit neurologic au prognostic legat de completitudine (ASIA A, șanse minime de recuperare; ASIA B-D, recuperare variabilă, mai bună cu decompresie precoce). Fracturile osteoporotice netratate evoluează spre cifoză progresivă multisegmentară cu impact respirator la vârstnic. SCIWORA la copil are prognostic variabil, în funcție de severitatea leziunii medulare la RMN.
...
Motivul internării: durere vertebrală localizată, eventuale simptome neurologice (amorțeală, slăbiciune, tulburări sfincteriene, esențial de întrebat direct). Istoric: mecanismul exact (energie înaltă versus traumatism minor osteoporotic), momentul producerii, pierdere de cunoștință/politraumatism asociat, evoluția simptomelor neurologice. Antecedente relevante: osteoporoză, spondilită anchilozantă sau spondiloză cervicală severă preexistentă, neoplasm cunoscut, traumatisme vertebrale anterioare. Factori de risc: osteoporoza, activități cu energie mare, la copil elasticitatea ligamentară (SCIWORA).

### 3. Examen clinic (3 min)

General: verificare ABC prioritar în politraumatism, mai ales la leziuni cervicale înalte cu risc respirator. Local, inspecție: deformare vizibilă (cifoză posttraumatică), echimoză/tumefacție paravertebrală, atitudine antalgică. Palpare: sensibilitate pe apofizele spinoase pe tot traiectul, contractură paravertebrală, treaptă palpabilă (semn de instabilitate posterioară majoră). Examen neurologic complet (ASIA): forța pe miotoamele cheie (biceps C5, extensor carp C6, triceps C7, flexor degete C8, abductor deget mic T1; iliopsoas L2, quadriceps L3, tibial anterior L4, extensor haluce L5, gastrocnemieni S1), scor 0-5; sensibilitate pe dermatoame, scor 0-1-2; sensibilitatea perianală și contracția sfincterului anal (sacral sparing); reflexul bulbocavernos. Mobilitate: se evită mobilizarea activă a coloanei până la excluderea instabilității. Mers: NU se testează la suspiciune de instabilitate netratată.
...
Radiografie standard față-profil ca screening. CT al segmentului afectat (la politraumatism, CT al întregii coloane): măsor procentul de compromitere a canalului, cominuția, cifoza segmentară (unghiul Cobb). RMN obligatorie pentru PLC/disco-ligamentar (esențial în zona gri TLICS/SLIC), disc, hematom epidural, starea medulară. Preoperator: hemogramă, coagulogramă, evaluare anestezică și cardio-pulmonară la leziuni cervicale înalte, densitometrie osoasă la suspiciune osteoporotică.
