...
Inelul pelvin este format din două arcuri osoase unite anterior prin simfiza pubiană și posterior prin articulațiile sacroiliace, stabilizate de ligamentele sacroiliace posterioare (cel mai important stabilizator, susține greutatea transmisă de coloană la membrele inferioare) și de ligamentele sacrospinos și sacrotuberos (rotația externă). Plexul venos presacrat și arterele iliace interne (gluteală superioară, obturatoare, pudendă) sunt sursa principală de hemoragie: sângerarea este predominant venoasă (80 la 85%), doar 10 la 20% arterială, dar cu potențial masiv prin volumul mare al spațiului retroperitoneal, fără tamponadă eficientă. Acetabulul este format din două coloane osoase (Judet-Letournel): anterioară (creastă iliacă la pubis) și posterioară (incizura ischiatică mare la tuberozitatea ischiatică), unite prin arcul acetabular. Nervul sciatic și artera gluteală superioară trec adiacent incizurii ischiatice mari, la risc direct la fracturile de coloană posterioară și la abordul Kocher-Langenbeck.

### Etiopatogenie

Inel pelvin: compresie antero-posterioară (APC, impact frontal, "open book"), compresie laterală (LC, impact lateral, cea mai frecventă în accidente rutiere, înfundare/rotație internă a hemipelvisului), forfecare verticală (VS, cădere de la înălțime pe un membru, cea mai instabilă), mecanism combinat (CM). Acetabul: forța se transmite prin capul femural, direcția impactului asupra genunchiului flectat determinând coloana afectată: șold în rotație internă/adducție produce pattern posterior, șold în abducție/rotație externă produce pattern anterior sau ambele coloane.
...
Inel pelvin: durere la compresia inelului (o singură dată, cu grijă, pentru a nu disloca un cheag deja format), instabilitate mecanică la mobilizarea blândă, echimoză perineală/scrotală/labială (semn Destot), discrepanță de lungime prin deplasare verticală, hematom retroperitoneal masiv (distensie abdominală, șoc fără sursă externă evidentă). Examinare obligatorie pentru leziuni asociate: tușeu rectal (sânge, prostată înaltă la bărbat), examen vaginal la femeie, inspecția meatului urinar (sânge, contraindică sondajul direct), inspecție cutanată completă (plăgi perineale/fesiere, fractură deschisă). Acetabul: durere la mobilizarea șoldului, impotență funcțională, examen neurologic al sciaticului (motor: extensie dorsală a piciorului; senzitiv: fața dorsală) obligatoriu la fracturile de coloană/perete posterior.
...
**Acetabul, indicații chirurgicale:** deplasare peste 2mm, roof arc sub 45 grade, instabilitate de șold, fragmente incarcerate, ambele coloane cu pierderea congruenței. Reducere anatomică cu placă/șuruburi este standardul la adultul tânăr; conversie acută la artroplastie (fix-and-replace) este tot mai folosită la vârstnic (peste 60-65 ani (?)) cu cominuție și osteoporoză, unde ORIF izolat are rezultate slabe, evitând o a doua intervenție.

**Abordurile pentru acetabul:** Kocher-Langenbeck (posterior, risc pentru sciatic și gluteala superioară), ilioinguinal (anterior, risc pentru pachetul femural și cutanat femural lateral), Stoppa modificat (intrapelvin, disecție musculară mai limitată, alternativă/complement la ilioinguinal). Fracturile ambele coloane sau T-shaped complexe pot necesita abord combinat.

**Rezultate:** calitatea reducerii (Matta: anatomică sub 1mm, imperfectă 1-3mm, slabă peste 3mm) corelează direct cu rezultatul funcțional; reducerea anatomică are rezultate bune la 70-80% la 10 ani, reducerea slabă crește riscul de artroză secundară.

### Complicații

Ale traumatismului: hemoragie masivă (principala cauză de deces precoce), leziune uretrală/vezicală/rectală, leziune neurologică (plex lombosacrat, sciatic), disfuncție sexuală. Ale tratamentului: tromboembolism venos (risc foarte crescut, profilaxie prelungită obligatorie), leziune iatrogenă de nerv sciatic/gluteal superior (Kocher-Langenbeck) sau de pachet femural (ilioinguinal), osificări heterotopice (profilaxie cu indometacin sau radioterapie la risc înalt), necroză avasculară a capului femural, artroză posttraumatică (corelată cu calitatea reducerii), infecție profundă la aborduri extensile.
...
Motivul internării: durere intensă pelvină/coxo-femurală, impotență funcțională, eventuale simptome de instabilitate hemodinamică. Istoric: mecanismul exact (impact frontal/lateral/cădere pe membru orientează spre mecanismul Young-Burgess), momentul producerii, manevre efectuate până la prezentare (binder prehospital). Antecedente relevante: osteoporoză, anticoagulante, afecțiuni urologice/ginecologice preexistente, sarcină la femeie. Factori de risc: energia traumatismului, osteoporoza la vârstnic, comorbidități care influențează toleranța la hemoragie.

### 3. Examen clinic (3 min)

General: prioritar evaluarea ABC și hemodinamică, pentru că fractura instabilă poate fi sursa unei hemoragii care pune viața în pericol. Local, inspecție: echimoză perineală/scrotală/labială (semn Destot), asimetrie a bazinului, discrepanță de lungime, poziția membrului. Palpare: compresie manuală a inelului (antero-posterioară și laterală), o singură dată, cu grijă, evitând mobilizări repetate care pot disloca un cheag hemostatic. Examen obligatoriu pentru leziuni asociate: meatul urinar (sânge, contraindică sondajul direct), tușeu rectal (sânge, poziția prostatei), examen vaginal la femeie, inspecție cutanată perineală/fesieră. Mobilitate: testare blândă coxo-femurală doar dacă suspiciunea este de fractură acetabulară izolată. Examen neuro-vascular distal: pulsuri femurale/pedale, sensibilitate și motricitate pe teritoriul sciaticului, esențial la fracturile de coloană/perete posterior.
...
Radiografie de bazin AP în urgență. CT cu reconstrucții 3D, standard pentru caracterizarea completă a inelului și acetabulului. Măsor: deschiderea simfizei, deplasarea verticală/posterioară a hemipelvisului, roof arc angle (normal peste 45 grade), gradul de cominuție. Screening asociat: uretrografie retrogradă, cistografie, examen ginecologic/rectal. Angio-CT la suspiciune de sângerare arterială activă, pacient stabilizat. Preoperator: hemogramă, coagulogramă, grup sanguin cu probă de compatibilitate (rezerve pentru transfuzie masivă), evaluare anestezică.

### 7. Tratament (3 min)

Obiective: control hemoragic imediat, stabilizare mecanică a inelului/reconstrucția congruenței acetabulare, prevenirea complicațiilor urologice/neurologice, mobilizare precoce. Opțiuni: pentru inel instabil, binder, resuscitare, preperitoneal packing/angioembolizare, fixare externă/internă; pentru acetabul, conservator (roof arc peste 45 grade) versus ORIF (deplasare peste 2mm) versus conversie acută la artroplastie la vârstnic cu os precar. Pentru acest pacient aleg [opțiunea concretă], pentru că [statusul hemodinamic, tipul de leziune, calitatea osoasă, vârsta].

Tehnica în pași (fixare a inelului cu șuruburi iliosacrate percutane și placare simfizară): 1) după stabilizare hemodinamică, decubit dorsal pe masă radio-transparentă; 2) reducere a diastazei simfizare și placare prin abord Pfannenstiel; 3) fluoroscopie pentru vizualizarea sacrului (inlet, outlet, laterală), verificând dismorfismul sacrat; 4) șuruburi iliosacrate percutane sub control fluoroscopic strict pe toate incidențele; 5) verificarea reducerii inelului; 6) pentru acetabul asociat, abord conform pattern-ului (Kocher-Langenbeck posterior, ilioinguinal/Stoppa anterior), reducere și fixare cu placă; 7) verificarea congruenței finale; 8) hemostază, drenaj, închidere.

Protocol postoperator: profilaxie tromboembolică prelungită, mobilizare progresivă cu sprijin parțial (6 la 12 săptămâni), kinetoterapie, monitorizare urologică/neurologică, control radiografic la 6 și 12 săptămâni.
