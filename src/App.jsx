...
export default function App({ user }) {
  ...
  if (!loaded) return <><style>{css}</style><div style={{ minHeight: "100vh", background: "#060c18", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'JetBrains Mono',monospace", fontSize: 11, color: "#334155", letterSpacing: 1 }}>SYNCING…</div></>;
